...
Este site ainda está em construção. Próximas seções previstas:
...
- **Conteúdos em Mídias Sociais**  
  Canais no YouTube, podcasts, perfis em redes sociais e iniciativas como *Elixir em Foco*.
...
Sugestões de novas entradas, correções ou atualizações são bem-vindas.

Você pode:

- Abrir uma *issue* neste repositório;
- Enviar um *pull request* com ajustes em arquivos `.md`;
- Entrar em contato pelos canais oficiais do Elixir em Foco.

---
_Última atualização: _(preencha aqui quando quiser)_.
